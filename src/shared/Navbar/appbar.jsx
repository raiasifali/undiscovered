  ...
  return (
    ...
    >
      <div className="flex items-center justify-between lg:justify-start gap-[30px] py-2 max-w-[1440px] mx-auto px-3 lg:px-0">
        ...
        <div
          ref={navBody}
          className={`flex fixed top-0 flex-grow lg:justify-between lg:relative  lg:items-center lg:flex-row flex-col gap-8 lg:gap-[55px] z-20  lg:bg-none lg:h-auto lg:w-fit w-[80%] h-screen pt-[30px] px-3 lg:pt-0 lg:px-0 shadow-2xl lg:shadow-none duration-300 ease-in-out  ${
