        ...
        <div className="mt-[18px] border-b-[2px] border-b-[#DBDBDB] flex flex-col gap-[6px] lg:gap-[20px] pb-[20px]">
            <div className="flex lg:hidden  items-center gap-[5px] ">
                <span className="flex gap-[18px] items-center w-[40%] lg:w-[35%]">
                    <img src={player?.picture} className="w-[60px]  lg:w-[60px] lg:h-[60px]  object-cover" alt="avatar" />
                    <p className=" font-sfPro text-[#4C8FE1] text-[18px] lg:text-[18px]">{player?.auth?.name}
                        <p className="text-black text-[14px] font-[400]">{player?.institute.universityName}</p>
                    </p>
                </span>
            ...
            <div className="lg:flex hidden  items-center gap-[5px] ">
                ...
                <span className="w-[20%] lg:w-[30%] flex gap-[20px] items-center">
                    <p className="text-black text-[16px] font-[400]">{player?.institute.universityName}</p>
                    <button
                        onClick={() => setCollapsed(!Collapsed)}
                        className={`cursor-pointer ease-in-out duration-300 w-4 h-4 ${!Collapsed ? "rotate-180" : ""
                            } `}
            ...
            <div className={`px-[20px] ${Collapsed ? "opacity-0 h-0 hidden" : "opacity-100 h-auto flex"}   flex-col gap-[20px] transition-all duration-500 ease-out`}>
