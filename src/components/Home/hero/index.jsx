    ...
    <div
      ...
      <div className='max-w-[1440px] mx-auto px-3 lg:px-[20px] min-h-screen flex items-center z-[100]'>
        <div className='flex flex-col gap-2 max-w-[700px]'>
          <h1 className='text-[36px] md:text-[50px] text-white mb-0'>
            GET RECRUITED
          </h1>
          <h1 className='text-[36px] md:text-[50px] text-primaryColor mb-0'>
            BE DISCOVERED
          </h1>
          <h1
            className='text-[36px] md:text-[50px] text-green mb-0'
            style={{
              textShadow:
          ...
          <div className='flex items-center gap-2 flex-col md:flex-row mt-4'>
            <button
